...
void logPot() {
  ...
  if (abs((int)actual - (int)ultimaLecturaLog) <= 8) {
    return;
  }
...
uint16_t obtenerLecturaSegura() {
  ...
  if (potDoble.lecturaEfectiva > 0 &&
      potDoble.lecturaEfectiva < 1024) {
